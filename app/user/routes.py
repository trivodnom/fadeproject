...
def profile():
    ...
    # ИСПРАВЛЕНИЕ ЗДЕСЬ: Проверяем, есть ли аватарка, и используем дефолтную, если нет
    avatar_filename = current_user.avatar if current_user.avatar else 'default.jpg'
    avatar_image = url_for('static', filename='avatars/' + avatar_filename)
